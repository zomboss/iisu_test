...
void HandModel::bentFinger(int fin, Array<Vector3> angle)
{
...
void HandModel::bentThumb(Array<Vector3> angle)
{
	// the main axis = (2,1,-2)
	...
	for(int t = 2; t >= 1; t--)		// 1!!!!
	{
		...
		Quaternion quat = Quaternion(w, x, y, z);
...
Array<int> HandModel::getAllFingersIndex()
{
	Array<int> fingerarray;
	for(int i = 16; i < 48; i++)
		fingerarray.pushBack(i);
	return fingerarray;
}

Array<Sphere> HandModel::getNeighbors(int index)
{
...
Array<ModelCoefficients> HandModel::getSkeleton()
{
	Array<ModelCoefficients> skeleton;
